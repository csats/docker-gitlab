...
# @sunil.  tries to pull 8.59.3, which doesn't exist.  
# see: https://gitlab.com/gitlab-org/gitlab-workhorse/-/tags?search=8.59&sort=updated_desc
# harcoding it to 8.59.2
